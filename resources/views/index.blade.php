    ...
    <body>
        <div class="flex-center full-height">
            <div class="content">
                ...
                <div><p>v1.2 : SoundCloud対応。ドメイン変更対応。ニコニコの読み込みをちょっとだけ高速化。</p></div>
                <div><p>v1.2.1 : SoundCloudのURLが入れられない問題を修正。背景にURLとか残ったままの問題を修正。</p></div>
                <div><p>v1.3 : アプリキーを生成するようになりました。（一番最初に部屋に入った人のみ表示）<br>アプリキーをアプリの方に入力することで現在再生中のものが表示されるようになります。<br>一部の記号が入っているとファイルが取得できない問題を修正。<br>アプリに表示されるURLを短縮URLに変更。</p></div>
                <div><p>v1.4 : 動画を指定秒数経過で自動スキップする機能を追加。</p></div>
            </div>
        </div>
    </body>
    <script>
