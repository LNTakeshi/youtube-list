    ...
    <body>
        <div class="flex-center full-height">
            <div class="content">
                ...
                <div><p>v1.5.5 : (web)ボタン表示微修正、送信中の挙動変更、アプリキーが表示されている人は全ての動画を消せるように変更。</p></div>
                <div><p>v1.6.0 : (web)twitterのURLを入力できるようになりました。動画じゃないと多分弾かれます。YoutubeのURL「youtu.be」にも対応しました。</p></div>
                <div><p>v1.6.1 : (app)保存に失敗する不具合を修正。</p></div>
                <div><p>v1.6.2 : SoundCloudの再生に失敗する問題の修正。（再）</p></div>
            </div>
        </div>
    </body>
    <script>
